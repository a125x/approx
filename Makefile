#############################################################################
# Makefile for building: approx.app/Contents/MacOS/approx
# Generated by qmake (3.1) (Qt 6.6.2)
# Project:  approx.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile approx.pro
#############################################################################
...
DISTDIR = /Users/a125x/projects/work/approx/.tmp/approx1.0.0
...
EXPORT__PRO_FILE_ = /Users/a125x/projects/work/approx/approx.pro
...
approx.app/Contents/MacOS/approx:  $(OBJECTS)  
	@test -d approx.app/Contents/MacOS/ || mkdir -p approx.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: approx.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.6.2_1/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.6.2_1/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.6.2_1/share/qt/mkspecs/common/macx.conf \
...
approx.app/Contents/PkgInfo: 
	@test -d approx.app/Contents || mkdir -p approx.app/Contents
	@$(DEL_FILE) approx.app/Contents/PkgInfo
	@echo "APPL????" > approx.app/Contents/PkgInfo
approx.app/Contents/Info.plist: 
	@test -d approx.app/Contents || mkdir -p approx.app/Contents
	@$(DEL_FILE) approx.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.approx,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.approx,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,approx,g" -e "s,@LIBRARY@,approx,g" -e "s,\$${EXECUTABLE_NAME},approx,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >approx.app/Contents/Info.plist

all: Makefile \
		approx.app/Contents/PkgInfo \
		approx.app/Contents/Info.plist approx.app/Contents/MacOS/approx
